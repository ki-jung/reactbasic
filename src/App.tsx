...
// <Routes> : <Route> 컴포넌트로 URL에 따른 컴포넌트 렌더링 할 수 있도록 하는 컴포넌트
...
function Layout() {
  ...
  // <Outlet> : 부모 <Route>에 해당 컴포넌트가 element로 등록 되었을때 
  //            자식 <Route>에 element가 해당 위치에 렌더링되도록 하는 컴포넌트
  ...
  return (
    <Routes>
      ...
      <Route path='/router'>
        ...
        <Route path='PathVariable/:name' element={<PathVariable />} />
